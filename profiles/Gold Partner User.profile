...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>FirstIntegration</apexClass>
        <enabled>false</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Assign_Entitlement_To_Case</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Notify_Case_Owner</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Stop_Milestone_Timer</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>Stop_Milestone_When_Case_Is_Closed</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
    ...
    <servicePresenceStatusAccesses>
        <enabled>false</enabled>
        <servicePresenceStatus>Available_Case</servicePresenceStatus>
    </servicePresenceStatusAccesses>
    <servicePresenceStatusAccesses>
        <enabled>false</enabled>
        <servicePresenceStatus>Break</servicePresenceStatus>
    </servicePresenceStatusAccesses>
    <servicePresenceStatusAccesses>
        <enabled>false</enabled>
